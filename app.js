...
const btnnElem = document.querySelector('.btnn');
...
btnnElem.addEventListener('click', showContainer);
...
function showContainer() {
    containerElem.style.display = "flex"; // Change 'none' to 'flex'
    containerElem.style.visibility = "visible"; // Change 'hidden' to 'visible'
  }
